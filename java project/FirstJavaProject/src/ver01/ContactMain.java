...
public class ContactMain {
	...
	public static void main(String[] args) {
        ...
        // 인스턴트 생성 => new 클래스이름 -> 클래스() 생성자 호출
		Contact contact1 = new Contact("손흥민", "010-0000-0000", 
				"son@gmail.com", "London", "2000-10-22", "친구");
		...
		// 데이터 변경(데이터 처음 등록, 수정 등등 다 데이터 변경에 속함): setter 메소드를 이용
