...
public class Calculator {
	...
	// 매개변수: 숫자 두 개를 매개변수의 인자로 전달받아 -> int num1, int num2, num1+num2,
	// num1+num2 => int
    ...
    // 매개변수: 숫자 두 개를 매개변수의 인자로 전달받아
		...
		// devide(1,2)
		// devide(1.5,2.0)
		// 메소드의 오버로딩은 메소드의 호출 시에 정해진다!
		int divide(int num1, int num2) {
			return num1/num2;
		}
		
		// 오버로딩: 메소드의 이름이 같은 메소드를 정의
		// 오버로딩의 조건: 이름이 같다, 매개변수의 개수 또는 매개변수의 개수 또는 매개변수의 타입이 달라야 한다! 
		// 변환타입은 의미없다!
