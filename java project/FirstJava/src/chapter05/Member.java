...
public class Member {
	...
	private String phone; // 010-9018-0000
	...
	public Member(String name, String phone, String major, int grade, String email) {
		// this.name=name;
		// this.phoneNumber=phoneNumber;
		// this.major=major;
		// this.grade=grade;
		// this.email=email;
		this(name, phone, major, grade, email, null, null);
